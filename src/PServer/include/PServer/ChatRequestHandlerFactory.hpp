...
#ifndef CHATREQUESTHANDLER_HPP
#define CHATREQUESTHANDLER_HPP

#include <Poco/Net/HTTPRequestHandlerFactory.h>
#include <PServer/PocoForwards.hpp>

class ChatRequestHandlerFactory: public Poco::Net::HTTPRequestHandlerFactory
{
public:
    ChatRequestHandlerFactory();

    Poco::Net::HTTPRequestHandler* createRequestHandler(const Poco::Net::HTTPServerRequest& request) override;

};

#endif // CHATREQUESTHANDLER_HPP